...
def generate_summary(student):
    """
    Generates a summary for a student using the Ollama API.
    
    Args:
        student (Student): The student object containing attributes like name, age, and email.

    Returns:
        str: The generated summary text from the Ollama API.
    """
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Attempt to parse the "response" field if it's JSON formatted
